...
class TestStatusCoordinateRender:
    ...
    def test_east_coast_2digit_lon(self, sim_display, request):
        ...
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_east_coast")
    ...
    def test_west_coast_3digit_lon(self, sim_display, request):
        ...
        sim_display.show_status()
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_west_coast")
    ...
    def test_alaska_extreme_3digit_lon(self, sim_display, request):
        ...
        sim_display.show_status()
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_alaska")
    ...
    def test_puerto_rico_2digit_lon(self, sim_display, request):
        ...
        sim_display.show_status()
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_puerto_rico")
    ...
    def test_plain_text_locating(self, sim_display, request):
        ...
        sim_display.show_status()
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_plain_text")
    ...
    def test_plain_text_error(self, sim_display, request):
        ...
        sim_display.show_status()
        assert_render_matches(request, sim_display._display.render_to_image(scale=8), "status_coords_plain_error")
